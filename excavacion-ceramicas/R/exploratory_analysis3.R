...
# Read the data set
ddata <- read.xlsx("data/piezas.xlsx", sheetIndex = 1, 
...
# Make a Scatter plot of Tipo o variedad - Unidad
...
# Make a Scatter plot of Tipo o variedad - Temporalidad
count.tipo.variedad.temporalidad <- group_by(ddata, Tipo.o.Variedad, Temporalidad) %>%
  summarise(Piezas = n())

tipo.variedad.temporalidad <- MyScatterPlot3(count.tipo.variedad.temporalidad,
                                             x.var = "Temporalidad",
                                             y.var = "Tipo.o.Variedad",
                                             fill.color = "orange",
                                             size.var = "Piezas")
tipo.variedad.temporalidad + ggtitle("Capa I y II")

str(count.tipo.variedad.temporalidad)
